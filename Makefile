# This Makefile is for the Tk::CanvasDirTree extension to perl.
#
# It was generated automatically by MakeMaker version
# 6.21_03 (Revision: 1.147) from the contents of
...
#     ABSTRACT_FROM => q[lib/Tk/CanvasDirTree.pm]
#     AUTHOR => q[zentara <zentara@zentara.net>]
#     NAME => q[Tk::CanvasDirTree]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Tk/CanvasDirTree.pm]
...
AR_STATIC_ARGS = cr
DIRFILESEP = /
NAME = Tk::CanvasDirTree
NAME_SYM = Tk_CanvasDirTree
VERSION = 0.01
...
FULLEXT = Tk/CanvasDirTree
BASEEXT = CanvasDirTree
PARENT_NAME = Tk
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Tk/CanvasDirTree.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Tk/CanvasDirTree.pm
...
TO_INST_PM = lib/Tk/CanvasDirTree.pm

PM_TO_BLIB = lib/Tk/CanvasDirTree.pm \
...
DISTNAME = Tk-CanvasDirTree
DISTVNAME = Tk-CanvasDirTree-0.01
...
manifypods : pure_all  \
	lib/Tk/CanvasDirTree.pm \
	lib/Tk/CanvasDirTree.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Tk/CanvasDirTree.pm $(INST_MAN3DIR)/Tk::CanvasDirTree.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_RF)  blib/lib/Tk/CanvasDirTree.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         Tk-CanvasDirTree' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:      0.01' >> META_new.yml
	$(NOECHO) $(ECHO) 'version_from: lib/Tk/CanvasDirTree.pm' >> META_new.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Perl Derived Canvas widget for browsing Directory Trees</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>zentara &lt;zentara@zentara.net&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib.ts: $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  lib/Tk/CanvasDirTree.pm blib/lib/Tk/CanvasDirTree.pm 
	$(NOECHO) $(TOUCH) $@
